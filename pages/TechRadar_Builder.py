"""
TechRadar Builder
Build adopt, trial, assess and hold technology radars
...
APP_NAME = "TechRadar Builder"
APP_ICON = "🧭"
APP_TAGLINE = "Build adopt, trial, assess and hold technology radars"
APP_KEY = "tech_radar"
FILE_PREFIX = "tech_radar"
CREATOR_FOOTNOTE = "Content created by Pradip Bhuyan, Head of Delivery, TMT."

SECTIONS = ['executive_summary', 'radar_method', 'adopt', 'trial', 'assess', 'hold', 'key_risks', 'investment_priorities', 'governance_recommendations', 'next_steps']
SECTION_LABELS = {'executive_summary': '🔭 Executive Summary', 'radar_method': 'Radar Method', 'adopt': 'Adopt', 'trial': 'Trial', 'assess': 'Assess', 'hold': 'Hold', 'key_risks': 'Key Risks', 'investment_priorities': 'Investment Priorities', 'governance_recommendations': 'Governance Recommendations', 'next_steps': '✅ Next Steps', 'top_developments': '🧭 Top Developments', 'analyst_take': '🧠 Analyst Take', 'what_to_watch_next': '👀 What To Watch Next'}
BRIEFING_OPTIONS = ['Technology Radar', 'Architecture Radar', 'AI and Cloud Radar']
...
# Prompts
# -----------------------------------------------------------------------------
DRAFT_PROMPT = """You are TechRadar Builder, a senior technology analyst and executive advisor.
Today is __DATE__.
...
REVIEW_PROMPT = """You are the Chief Advisory Editor for TechRadar Builder.
...
TTS_PROMPT = """You are TechRadar Builder, a professional broadcast scriptwriter for senior technology executives.
...
def generate_draft(client: openai.OpenAI, model: str, briefing_type: str, user_context: str) -> dict:
    ...
    prompt = (DRAFT_PROMPT
        .replace("TechRadar Builder", APP_NAME)
        ...
        .replace("__PROMPT_EXTRA__", "Create a technology radar using the rings Adopt, Trial, Assess and Hold. Classify technologies by maturity, enterprise readiness, strategic value, risk and investment priority.")
...
def review_draft(client: openai.OpenAI, model: str, draft: dict) -> dict:
    ...
    prompt = REVIEW_PROMPT.replace("TechRadar Builder", APP_NAME).replace("__DRAFT__", json.dumps(slim, indent=2, ensure_ascii=False))
