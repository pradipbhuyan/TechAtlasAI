"""
DevOps Radar
DevOps, SRE, platform engineering and observability intelligence
...
APP_NAME = "DevOps Radar"
APP_ICON = "🛠️"
APP_TAGLINE = "DevOps, SRE, platform engineering and observability intelligence"
APP_KEY = "devops_radar"
FILE_PREFIX = "devops_radar"
CREATOR_FOOTNOTE = "Content created by Pradip Bhuyan, Head of Delivery, TMT."

SECTIONS = ['executive_summary', 'top_developments', 'platform_engineering', 'cicd_gitops', 'sre_observability', 'kubernetes_cloud_native', 'developer_productivity', 'security_supply_chain', 'tooling_vendor_moves', 'analyst_take', 'what_to_watch_next']
SECTION_LABELS = {'executive_summary': '🔭 Executive Summary', 'top_developments': '🧭 Top Developments', 'platform_engineering': 'Platform Engineering', 'cicd_gitops': 'Cicd Gitops', 'sre_observability': 'Sre Observability', 'kubernetes_cloud_native': 'Kubernetes Cloud Native', 'developer_productivity': 'Developer Productivity', 'security_supply_chain': 'Security Supply Chain', 'tooling_vendor_moves': 'Tooling Vendor Moves', 'analyst_take': '🧠 Analyst Take', 'what_to_watch_next': '👀 What To Watch Next', 'next_steps': '✅ Next Steps'}
BRIEFING_OPTIONS = ['Weekly DevOps Radar', 'Daily DevOps Flash', 'Platform Engineering Brief']
...
# Prompts
# -----------------------------------------------------------------------------
DRAFT_PROMPT = """You are DevOps Radar, a senior technology analyst and executive advisor.
Today is __DATE__.
...
REVIEW_PROMPT = """You are the Chief Advisory Editor for DevOps Radar.
...
TTS_PROMPT = """You are DevOps Radar, a professional broadcast scriptwriter for senior technology executives.
...
def generate_draft(client: openai.OpenAI, model: str, briefing_type: str, user_context: str) -> dict:
    ...
    prompt = (DRAFT_PROMPT
        ...
        .replace("__PROMPT_EXTRA__", "Create an executive DevOps and platform engineering briefing covering CI/CD, GitOps, SRE, observability, Kubernetes, developer productivity, supply chain security, and vendor moves.")
...
def review_draft(client: openai.OpenAI, model: str, draft: dict) -> dict:
    ...
    prompt = REVIEW_PROMPT.replace("DevOps Radar", APP_NAME).replace("__DRAFT__", json.dumps(slim, indent=2, ensure_ascii=False))
