"""
Architecture Library AI
Reference architecture patterns and implementation guides
...
APP_NAME = "Architecture Library AI"
APP_ICON = "🏛️"
APP_TAGLINE = "Reference architecture patterns and implementation guides"
APP_KEY = "architecture_library"
FILE_PREFIX = "architecture_library"
CREATOR_FOOTNOTE = "Content created by Pradip Bhuyan, Head of Delivery, TMT."

SECTIONS = ['executive_summary', 'architecture_context', 'reference_pattern', 'components', 'data_flow', 'security_controls', 'implementation_steps', 'risks_and_tradeoffs', 'operating_model', 'kpis', 'next_steps']
SECTION_LABELS = {'executive_summary': '🔭 Executive Summary', 'architecture_context': 'Architecture Context', 'reference_pattern': 'Reference Pattern', 'components': 'Components', 'data_flow': 'Data Flow', 'security_controls': 'Security Controls', 'implementation_steps': 'Implementation Steps', 'risks_and_tradeoffs': 'Risks And Tradeoffs', 'operating_model': 'Operating Model', 'kpis': 'Kpis', 'next_steps': '✅ Next Steps', 'top_developments': '🧭 Top Developments', 'analyst_take': '🧠 Analyst Take', 'what_to_watch_next': '👀 What To Watch Next'}
BRIEFING_OPTIONS = ['Reference Architecture', 'Solution Pattern', 'Implementation Blueprint']
...
# Prompts
# -----------------------------------------------------------------------------
DRAFT_PROMPT = """You are Architecture Library AI, a senior technology analyst and executive advisor.
Today is __DATE__.
...
REVIEW_PROMPT = """You are the Chief Advisory Editor for Architecture Library AI.
...
TTS_PROMPT = """You are Architecture Library AI, a professional broadcast scriptwriter for senior technology executives.
...
def generate_draft(client: openai.OpenAI, model: str, briefing_type: str, user_context: str) -> dict:
    ...
    prompt = (DRAFT_PROMPT
        .replace("Architecture Library AI", APP_NAME)
        ...
        .replace("__PROMPT_EXTRA__", "Create a reference architecture pattern with components, data flow, security controls, implementation steps, risks, operating model, KPIs and next steps. Include practical enterprise delivery guidance.")
...
def review_draft(client: openai.OpenAI, model: str, draft: dict) -> dict:
    ...
    prompt = REVIEW_PROMPT.replace("Architecture Library AI", APP_NAME).replace("__DRAFT__", json.dumps(slim, indent=2, ensure_ascii=False))
